<link rel="stylesheet" href="../miki_styles/chat_style.css" media="all">
...
<div class="alert alert-warning" role="alert">
	...
	<br>
	<p>Чтобы добавлять комментарии - зарегистрируйтесь или войдите в <a href="./miki_login/login.php">Учётную запись</a>.</p>
</div>
<?php else:?>
