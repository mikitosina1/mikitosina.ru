...
if(empty($_POST['go_message'])){
	if($_POST['message'] != '' && $_POST['authors_login'] != ''){
		...
		$authors_login = mysqli_real_escape_string($authors_login);
		...
		$mes_result = mysqli_query("INSERT INTO messages (authors_login, message, date) VALUES ('$authors_login', '$message', '$date')");
		if($mes_result == true){
...
header('Location: https://miktosina.ru');
?>